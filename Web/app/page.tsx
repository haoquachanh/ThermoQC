...
const issueData = [
  { name: "Activities", value: 540, color: "hsl(var(--chart-1))" },
  { name: "Warnings", value: 87, color: "hsl(var(--chart-4))" },
  { name: "Errors", value: 23, color: "hsl(var(--chart-5))" },
];
    ...
    <Layout>
      <div className="flex flex-col gap-4">
        ...
        <p className="text-muted-foreground">
          Welcome to your ThermoQC dashboard. Monitor activities, warnings, and
          errors.
        </p>
            ...
            <div className="grid gap-4 md:grid-cols-2">
                ...
                <CardContent className="pl-2">
                  <ResponsiveContainer width="100%" height={350}>
                    <BarChart data={activityData}>
                      ...
                      <YAxis />
                      <Tooltip />
                      <Bar dataKey="activities" fill="hsl(var(--chart-1))" />
                    </BarChart>
                  </ResponsiveContainer>
                </CardContent>
              </Card>
              <Card className="col-span-1">
                <CardHeader>
                  ...
                  <CardDescription>
                    Breakdown of activities, warnings, and errors
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <ResponsiveContainer width="100%" height={350}>
          ...
          <TabsContent value="analytics" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Detailed analysis of your system performance
                </CardDescription>
              </CardHeader>
              <CardContent>
